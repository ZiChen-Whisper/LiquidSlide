...
export const MATERIAL_PRESETS = [
  ...
  { id: "white", name: "白色玻璃", description: "适合深色文字", overrides: { ior: 1.5, blur: 12, displacementFactor: 0.45, specularStrength: 0.8, oppositeSpecularStrength: 0.8, tint: { r: 1, g: 1, b: 1, a: 0.6 } } },
  ...
  { id: "frost", name: "柔雾磨砂", description: "柔化复杂背景", overrides: { ior: 1.5, blur: 22, bezelWidth: 24, displacementFactor: 0.35, dispersion: 0.015, specularStrength: 0.65, oppositeSpecularStrength: 0.65, tint: { r: 1, g: 1, b: 1, a: 0.1 } } }
